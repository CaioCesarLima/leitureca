...
import 'package:leitureca/app/modules/admin/home/admin_home_binding.dart';
...
import 'app/modules/admin/widgets/bottombar/bottom_bar_controller.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Get.lazyPut<AdminBottomBarController>(() => AdminBottomBarController());
